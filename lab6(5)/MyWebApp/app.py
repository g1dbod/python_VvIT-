        ...
        if request.form.get("login"):
            ...
            if username != "" and password != "":
                ...
                if not records:
                    ...
                    return render_template('account.html', full_name=records[0])
            else:
                return render_template('login.html', not_name=True)
...
def registration():
    if request.method == 'POST':
        ...
        if name!="" and login!="" and password!="":
            ...
            return render_template('registration.html', not_data=True)
